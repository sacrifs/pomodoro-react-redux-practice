...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TimerAction = __webpack_require__(186);
	
	var TimerAction = _interopRequireWildcard(_TimerAction);
	
	var _SettingAction = __webpack_require__(187);
	
	var SettingAction = _interopRequireWildcard(_SettingAction);
	
	var _TimerComponent = __webpack_require__(188);
	
	var _TimerComponent2 = _interopRequireDefault(_TimerComponent);
	
	var _SettingComponent = __webpack_require__(190);
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_TimerComponent2.default, _extends({}, this.props.timerDispatch, this.props.timerProp)),
					_react2.default.createElement(_SettingComponent2.default, _extends({}, this.props.settingDispatch, this.props.settingProp))
				);
			}
		}]);
	...
	function mapDispatchToProps(dispatch) {
		return {
			timerDispatch: {
				timerInit: function timerInit(setting) {
					dispatch(SettingAction.saveSetting());
					dispatch(TimerAction.timerInit(setting));
				},
				timerStart: function timerStart() {
					return dispatch(TimerAction.timerStart());
				},
				timerStop: function timerStop() {
					return dispatch(TimerAction.timerStop());
				},
				timerReset: function timerReset() {
					return dispatch(TimerAction.timerReset());
				},
				timerFinish: function timerFinish() {
					return dispatch(TimerAction.timerFinish());
				},
				timerTick: function timerTick() {
					return dispatch(TimerAction.timerTick());
				}
			},
			settingDispatch: {
...
/***/ function(module, exports) {
	...
	exports.timerFinish = timerFinish;
	var TIMER_INIT = exports.TIMER_INIT = "timerInit";
	var TIMER_TICK = exports.TIMER_TICK = "timerTick";
	var TIMER_START = exports.TIMER_START = "timerStart";
	var TIMER_STOP = exports.TIMER_STOP = "timerStop";
	var TIMER_FINISH = exports.TIMER_FINISH = "timerFinish";
	
	function timerInit(setting) {
		return {
			type: TIMER_INIT, setting: setting
		};
	}
	function timerStart() {
		return {
...
/***/ function(module, exports) {
	...
	var SAVE_SETTING = exports.SAVE_SETTING = "saveSetting";
	
	function saveSetting(setting) {
		return {
			type: SAVE_SETTING, setting: setting
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppConst = __webpack_require__(189);
	...
	var TimerComponent = function (_Component) {
		...
		_createClass(TimerComponent, [{
			...
			value: function timerFunc() {
				if (this.props.status == AppConst.STATUS_STOP || this.props.isPause) {
					return;
				}
			...
			value: function formatTime(time) {
				...
				var minText = "" + minutes;
				var secText = ("0" + seconds).slice(-2);
				return { minText: minText, secText: secText };
			}
		}, {
			key: "getStatusText",
			...
			value: function render() {
				...
				var pomodoroCount = _props.pomodoroCount;
	
				var _formatTime = this.formatTime(time);
	
				var minText = _formatTime.minText;
				var secText = _formatTime.secText;
	
				var statusText = this.getStatusText(status);
				var pomodoroCountSquare = this.getSquare(pomodoroCount);
				return _react2.default.createElement(
					"div",
					{ className: "timer_component" },
					_react2.default.createElement(
						"p",
						{ className: "timer_time_text" },
						minText,
						":",
						secText
					),
					_react2.default.createElement(
						"p",
						{ className: "timer_status_text" },
						statusText
					),
					_react2.default.createElement(
						"p",
						{ className: "timer_pomodoro_count" },
						pomodoroCountSquare
					),
					_react2.default.createElement(
						"button",
						{ onClick: function onClick(e) {
								return _this3.props.timerStart();
							} },
						"START"
					),
					_react2.default.createElement(
	...
	TimerComponent.propTypes = {
		...
		isPause: _react.PropTypes.bool.isRequired,
		timerInit: _react.PropTypes.func.isRequired,
		timerStart: _react.PropTypes.func.isRequired,
		timerStop: _react.PropTypes.func.isRequired,
		timerFinish: _react.PropTypes.func.isRequired,
		timerTick: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports) {
	...
	var STATUS_WORKING = exports.STATUS_WORKING = 1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SettingComponent = function (_Component) {
		_inherits(SettingComponent, _Component);
	
		function SettingComponent() {
			_classCallCheck(this, SettingComponent);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(SettingComponent).apply(this, arguments));
		}
		...
		_createClass(SettingComponent, [{
			...
			value: function btnSaveClick() {
				...
				this.props.saveSetting({ workTime: workTime, breakTime: breakTime, longBreakTime: longBreakTime });
			}
		}, {
			key: "render",
			value: function render() {
				...
				return _react2.default.createElement(
					"div",
					{ className: "setting_component" },
					_react2.default.createElement(
						"label",
						{ className: "setting_time_label setting_worktime_label" },
						_react2.default.createElement(
							"span",
							{ className: "setting_label_text" },
							"WorkTime:"
						),
						_react2.default.createElement("input", { className: "setting_time_input setting_worktime_min", defaultValue: workTime, ref: "workTime", type: "text" }),
						" min."
					),
					_react2.default.createElement(
						"label",
						{ className: "setting_time_label etting_breaktime_label" },
						_react2.default.createElement(
							"span",
							{ className: "setting_label_text" },
							"BreakTime:"
						),
						_react2.default.createElement("input", { className: "setting_time_input setting_breaktime_min", defaultValue: breakTime, ref: "breakTime", type: "text" }),
						" min."
					),
					_react2.default.createElement(
						"label",
						{ className: "setting_time_label setting_longbreak_label" },
						_react2.default.createElement(
							"span",
							{ className: "setting_label_text" },
							"LongBreakTime:"
						),
						_react2.default.createElement("input", { className: "setting_time_input setting_longbreak_min", defaultValue: longBreakTime, ref: "longBreakTime", type: "text" }),
						" min."
					),
					_react2.default.createElement(
						"button",
						{ onClick: function onClick(e) {
								return _this2.btnSaveClick();
							}, "class": "setting_save_btn" },
						"SAVE"
					)
				);
			}
	...
	SettingComponent.propTypes = {
		saveSetting: _react.PropTypes.func.isRequired,
		workTime: _react.PropTypes.number.isRequired,
		breakTime: _react.PropTypes.number.isRequired,
		longBreakTime: _react.PropTypes.number.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setting = __webpack_require__(193);
	...
	function timer() {
		...
		switch (action.type) {
			...
			case TimerAction.TIMER_START:
				{
					var workTime = state.setting.workTime;
			...
			case TimerAction.TIMER_STOP:
				{
					var _workTime = state.setting.workTime;
	
					return Object.assign({}, state, { time: _workTime, status: AppConst.STATUS_STOP });
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = AppConst.DEFAULT_TIME;
